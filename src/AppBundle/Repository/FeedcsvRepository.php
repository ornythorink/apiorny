...
SQL
    ...
    public function resetFeeds($locale)
    {
        $conn = $this->getEntityManager()->getConnection();

        /*$qb = $this->_em->createQueryBuilder();
        $qb->update('AppBundle:Feedcsv', 'p')->set('p.flagbatched' , 'N');
        $qb->where('p.locale = :locale')->setParameter('locale', $locale);
        $updated = $qb->getQuery()->execute();*/

        $sql = 'UPDATE feedcsv SET flagbatched = "N" WHERE locale = :locale';
